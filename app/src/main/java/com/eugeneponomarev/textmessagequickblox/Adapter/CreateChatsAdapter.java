...
public class CreateChatsAdapter extends BaseAdapter {

    private Context context;
    private ArrayList<QBUser> qbUserArrayList;

    public CreateChatsAdapter(Context context, ArrayList<QBUser> qbUserArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            ...
            nameContact.setText(qbUserArrayList.get(position).getFullName());
        }
